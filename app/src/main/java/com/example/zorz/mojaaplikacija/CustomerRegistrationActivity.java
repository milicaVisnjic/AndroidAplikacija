    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegistration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email.isEmpty()) {
                    Toast.makeText(CustomerRegistrationActivity.this, "You must enter your email address.", Toast.LENGTH_SHORT).show();
                    mEmail.requestFocus();
                } else if (password.isEmpty()) {
                    Toast.makeText(CustomerRegistrationActivity.this, "You must enter your password.", Toast.LENGTH_SHORT).show();
                    mPassword.requestFocus();
                }
                else if (passconfirm.isEmpty()) {
                    Toast.makeText(CustomerRegistrationActivity.this, "You need to confirm your password.", Toast.LENGTH_SHORT).show();

                }
                else if (!password.equals(passconfirm)) {
                    Toast.makeText(CustomerRegistrationActivity.this, "Your passwords don't match.", Toast.LENGTH_SHORT).show();
                }else {
